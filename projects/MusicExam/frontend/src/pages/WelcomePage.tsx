      ...
      <div className="flex-1 flex flex-col lg:flex-row items-center justify-center px-6 lg:px-12 2xl:px-16 gap-8 lg:gap-12 2xl:gap-16">
        ...
        <div className="relative w-full max-w-md lg:max-w-lg 2xl:max-w-2xl aspect-square lg:aspect-[4/3] 2xl:aspect-[16/9]">
          ...
          <div className="relative w-full h-full">
            {/* Background shapes */}
            <div className="absolute top-4 left-4 w-32 h-32 rounded-[32px] bg-pink-soft/80 rotate-12" />
            <div className="absolute bottom-8 right-6 w-40 h-40 rounded-[32px] bg-mint/70 -rotate-6" />
            <div className="absolute top-1/3 right-8 w-24 h-24 rounded-full bg-purple-lavender/80" />
            <div className="absolute bottom-1/4 left-8 w-20 h-20 rounded-full bg-yellow-cream" />
        ...
        <div className="text-center lg:text-left max-w-sm 2xl:max-w-lg">
          <div className="flex items-center justify-center lg:justify-start gap-2 mb-2">
            ...
            <h2 className="text-responsive-lg font-bold text-coral tracking-wide">MusicExam</h2>
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-[clamp(1.5rem,4vw,2.5rem)] py-[clamp(0.75rem,1.5vw,1.25rem)] rounded-btn bg-dark text-white text-responsive-lg font-bold hover:shadow-lg hover:-translate-y-1 transition-all duration-200 shadow-md"
          >
